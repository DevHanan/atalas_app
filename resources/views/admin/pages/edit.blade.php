        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form class="needs-validation" novalidate action="{{ route('admin.pages.update',[$page]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    <div class="card-block">
                        <!-- Form Start -->
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" name="title" id="title" value="{{ old('title',$page) }}" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img src="{{ asset($page->image) }}" class="img-fluid setting-image" alt="{{ __('field_site_logo') }}">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control texteditor" name="description" id="description">{{ old('description',$page) }}</textarea>
