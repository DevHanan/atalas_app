                    ...
                    <div class="card-block row">
                        ...
                        <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-12">
                            <label for="short_description">{{ __('field_short_description') }}: <span>{{ __('field_meta_desc_length') }}</span></label>
                            <textarea class="form-control" name="short_description" id="short_description">{{ isset($row->short_description)?$row->short_description:'' }}</textarea>

                            <div class="invalid-feedback">
                              {{ __('required_field') }} {{ __('field_short_description') }}
                            </div>
                        </div>
